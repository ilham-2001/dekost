                                ...
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5">
                                        <div class="text-center">
                                            <h4 class="mt-1 mb-5 pb-1"> <img class="pb-2 pe-2" src="../owner/assets/icons/logo.png" style="width: 50px; height:50px;" alt="logo">De'Kost</h4>
                                        </div>
                                        ...
                                        <p class="mb-2 text-center" style="color:#2155CD ;">&copy;2022 De'kost All rights reserved</p>
                                    </div>
                                </div>
                            </div>
                        </div>
